...
const videos = [
  ...
  {
    id: 4,
    title: 'Vesper talk on meteora tech; a clip',
  ...
  {
    id: 5,
    title: 'Explanatory video for project: AiTv',
   ...
   {
    id: 6,
    title: 'Founder of Unfungible, speaking on building in the near market; a clip',
    description: 'Viral clips series that built credibility and reach',
    thumbnail: 'professional presentation',
    category: 'Content',
    videoUrl: Videosix,
...
function VideoCard({ video, index, isInView }: { video: typeof videos[0]; index: number; isInView: boolean }) {
  ...
  return (
    ...
    >
      <motion.div
        className="relative bg-gray-900 rounded-2xl overflow-hidden border-2 border-gray-800"
        whileHover={{ 
          y: -10,
          borderColor: '#ffffff',
        }}
      ...
      >
        ...
        <div className="relative aspect-video overflow-hidden bg-gray-800">
          ...
          >
            {/* Replace this with actual video source when available here*/}
            <source src={video.videoUrl} type="video/mp4" />
          </video>

          <div className="absolute inset-0 bg-gradient-to-t from-black via-black/30 to-transparent pointer-events-none" />

          {/* Video controls overlay here*/}
          <motion.div
...
export function VideoPortfolio() {
  ...
  return (
    <section className="relative py-20 lg:py-32 bg-gradient-to-b from-black to-gray-900 overflow-hidden">
